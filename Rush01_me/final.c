...
int check_pov_col_up(int arr[6][6], int y, int x, int num);
int check_pov_col_down(int arr[6][6], int y, int x, int num);
int check_pov_line_left(int arr[6][6], int y, int x, int num);
int check_pov_line_right(int arr[6][6], int y, int x, int num)
;
...
int check(int arr[6][6], int y, int x, int num)
{
    ...
    if(!check_pov_col_up(arr,y,x,num)) //tj vrai
        return (0);
    if(!check_pov_col_down(arr,y,x,num)) // quasi tj faux
        return (0);
    if(!check_pov_line_left(arr,y,x,num)) //tj vrai
        return (0);
    if(!check_pov_line_right(arr,y,x,num))// quasi tj faux
        return (0);
    return (1);
}
int check_pov_col_up(int arr[6][6], int y, int x, int num)
