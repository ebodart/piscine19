...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2020/09/19 11:03:30 by sheimann          #+#    #+#             */
/*   Updated: 2020/09/19 11:07:57 by sheimann         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int check(int arr[6][6], int y, int x, int num)
{
    ...
    if(arr[1][x] != 0 && arr[2][x] != 0 && arr[3][x] != 0 && arr[4][x] != 0)
    {
        if(!check_pov_col_up(arr,y,x) && !check_pov_col_down(arr,y,x))
            return (0);
    }
    if(arr[y][1] != 0 && arr[y][2] != 0 && arr[y][3] != 0 && arr[y][4] != 0)
    {
        if(!check_pov_line_left(arr,y,x) && !check_pov_line_right(arr,y,x))
            return (0);
    }
    return (1);
}
